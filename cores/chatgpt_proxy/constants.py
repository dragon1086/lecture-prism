...
# Token storage
#
# Keep the lecture repo's token file separate from the full PRISM-INSIGHT repo.
# Students can safely experiment here without overwriting the instructor's
# production PRISM token cache.
AUTH_DIR = Path.home() / ".config" / "lecture-prism"
