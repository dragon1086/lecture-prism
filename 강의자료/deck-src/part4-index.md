...
| --- | --- | --- | --- |
| P4-S01 | — | `part4/00-foundation.html` | 내 전략을 코드로 옮기고 혼자서 다음 수정까지 이어 갑니다 |
| P4-S02 | — | `part4/00-foundation.html` | 수업이 끝나면 원하는 변화를 직접 맡기고 확인할 수 있습니다 |
| P4-S03 | P4-00 | `part4/00-foundation.html` | MY_STRATEGY.md에서 오늘 바꿀 한 가지를 고릅니다 |
| P4-S04 | P4-KIS | `part4/00-foundation.html` | KIS 실제 수급을 분석에 한 번 연결합니다 |
| P4-S05 | P4-01 | `part4/00-foundation.html` | 한 번 실행하면 다섯 단계가 차례로 움직입니다 |
| P4-S06 | P4-01 | `part4/01-service-core.html` | 프로젝트 폴더에는 역할별 파일이 모여 있습니다 |
| P4-S07 | P4-01 | `part4/01-service-core.html` | main.py의 run_pipeline이 다른 파일의 함수를 순서대로 부릅니다 |
| P4-S08 | P4-01 | `part4/01-service-core.html` | 함수는 값을 받아 일을 하고 결과를 돌려줍니다 |
| P4-S09 | P4-01 | `part4/01-service-core.html` | main.py는 다른 파일의 함수를 가져와 실행하고 결과를 넘깁니다 |
| P4-S10 | — | `part4/01-service-core.html` | 코드는 그대로 두고 실행할 환경만 설정에서 고릅니다 |
...
| P4-S26 | P4-05~P4-08 | `part4/04-strategy-choice.html` | 잘 고쳤는지는 코드 양이 아니라 달라진 결과로 판단합니다 |
| P4-S27 | — | `part4/04-strategy-choice.html` | 실제 구독자 질문을 오늘의 강사 시연으로 사용합니다 |
| P4-S28 | P4-04 | `part4/04-strategy-choice.html` | 한 통합 프롬프트 안에서도 네 작업은 순서대로 검증합니다 |
| P4-S29 | P4-D1~P4-D4 | `part4/04-strategy-choice.html` | 진입은 screening.py, 청산은 trading.py가 맡습니다 |
| P4-S30 | P4-D1~P4-D4 | `part4/04-strategy-choice.html` | 터틀 구현 프롬프트에는 입력과 확인 방법을 함께 적습니다 |
| P4-S31 | P4-D1~P4-D4 | `part4/04-strategy-choice.html` | 터틀 구현은 후보와 청산 사유로 확인합니다 |
| P4-S32 | P4-D1~P4-D4 | `part4/04-strategy-choice.html` | ATR은 변동성을 손절 폭과 수량으로 바꿉니다 |
